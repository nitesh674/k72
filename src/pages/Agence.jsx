...
export default function Agence() {
  ...
  return (
    <div >
      ...
      <div ref={imageDevRef} className='scrolldev h-[20vw] w-[15vw] rounded-3xl absolute top-[30vh] left-105 overflow-hidden'>
