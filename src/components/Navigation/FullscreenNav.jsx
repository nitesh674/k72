...
function FullscreenNav() {
    ...
    return (
        <div id='FillScreenNav' className='h-screen  overflow-hidden w-full absolute   text-white bg-black'>
            <div className='flex w-full top-0 justify-between items-start '>
                ...
                <div className='w-30 h-20 relativ'>
                    <div className='h-39 w-0.5 bg-amber-300 absolute -rotate-45 origin-top-left' ></div>
                    <div className='h-39 w-0.5 bg-amber-300 absolute  right-0 rotate-45 origin-top' ></div>
                </div>
            </div>
