...
function FullscreenNav() {
    ...
    return (
        <div id='FillScreenNav' className='h-screen py-29 w-full absolute   text-white bg-black'>
            ...
            <div className=' footer w-full h-[10vh] bg-amber-300  mt-10  overflow-hidden flex justify-between'>


                <div className='w-[30vw] h-[10vh] bg-red-500 flex items-center'>
                    <div className=' w-[10vw] flex justify-around'>
                        <h1>frist</h1>
                        <h1>frist</h1>
                    </div>
                </div>
                <div className='w-[30vw] h-[10vh] bg-red-500 '>
                    <h1>frist</h1>
                </div>
                <div className='w-[30vw] h-[10vh] bg-red-500 '>
                    <h1>frist</h1>
