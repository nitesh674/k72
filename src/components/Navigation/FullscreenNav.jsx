...
function FullscreenNav() {
    ...
    return (
        <div ref={fullScreenRef} id='FillScreenNav' className='fullscreennav  h-screen  overflow-hidden w-full absolute z-50 text-white'>
            ...
            <div ref={fullNavLinkRef} className='relative'>
                <div className=" navLink flex w-full top-0 justify-between items-start px-4 py-2">
                    <div className="w-32">
