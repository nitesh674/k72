  ...
  return (
    <div className='flex justify-between fixed top-0 w-full z-4 '>
      ...
      <div onClick={()=>{
        ...
        className='rightNav w-55 h-13 relative bg-black  overflow-hidden'>
        ...
        <div ref={navGreenRef} className="bg-[#D3FD50] transition-all absolute top-0 w-full h-0 z-0">
